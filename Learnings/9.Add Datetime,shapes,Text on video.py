...
cap = cv2.VideoCapture(0,"""/Path of the video,if  not use of web cam""")  #for warn 0 just pass cv2.CAP_DSHOW
print("for width===",cap.get(cv2.CAP_PROP_FRAME_WIDTH))
print("for height==",cap.get(cv2.CAP_PROP_FRAME_HEIGHT))

#Alternate option to get height and width
...
while(cap.isOpened()):
    ...
    if ret == True:
       ...
       text = ' Height: ' + str(cap.get(4))+' Width: '+ str(cap.get(3)) #Here we concatenate into str
