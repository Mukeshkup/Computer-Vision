...
#sum of both the weight  = weight1 + weight2 = 1(max)
#function cv2.addWeighted(img1,wt1,img2,wt2,gama_val) 
#Weight of img is is the % of their weitage
result2 = cv2.addWeighted(img1,0.7,img2,0.3,0) #(wt1=0.7,wt2=0.3  0.7+0.3 = 1)
